...
namespace TaskManager.Services
{
    ...
    public class ApplicationServicesBase
    {
        ...
        {
            TaskManager.Services.ApplicationServices.Initialize();
        }
        ...
        public static void RegisterStandardMembershipAccounts()
        {
            ...
            if (css == null)
            	css = ConfigurationManager.ConnectionStrings["TaskManager"];
            ...
            if (Membership.GetUser("admin") == null)
            {
                ...
                admin = Membership.CreateUser("admin", "admin123%", "admin@TaskManager.com", "ASP.NET", "Code OnTime", true, out status);
                user = Membership.CreateUser("user", "user123%", "user@TaskManager.com", "ASP.NET", "Code OnTime", true, out status);
