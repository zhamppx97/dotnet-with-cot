...
namespace TaskManager.Handlers
{
    ...
    public class SiteBase : TaskManager.Web.PageBase
    {
        ...
        public static string Copyright
        {
            get
            {
                return "&copy; 2018 TaskManager. ^Copyright^All rights reserved.^Copyright^";
            }
        }
        ...
        protected virtual void InitializeSiteMaster()
        {
            ...
            string themePath = Server.MapPath("~/App_Themes/TaskManager");
            if (Directory.Exists(themePath))
            	foreach (string stylesheetFileName in Directory.GetFiles(themePath, "*.css"))
                {
                    ...
                    if (!(fileName.Equals("_Theme_Aquarium.css")))
                    {
                        ...
                        link.Href = ("~/App_Themes/TaskManager/" + fileName);
