...
namespace TaskManager.Data
{
	public class ControllerConfiguration
    {
        ...
        protected virtual void Initialize(XPathNavigator navigator)
        {
            ...
            {
                Type t = Type.GetType("TaskManager.Rules.SharedBusinessRules");
                if (t != null)
        ...
        public virtual void Complete()
        {
            ...
            if (String.IsNullOrEmpty(_connectionStringName))
            	_connectionStringName = "TaskManager";
...
<action id=""a5"" commandName=""Edit"" causesValidation=""true"" />
        ...
        public string LoadLayout(string view)
        {
            ...
            while (tryLoad)
            {
                ...
                {
                    Stream stream = GetType().Assembly.GetManifestResourceStream(String.Format("TaskManager.Views.{0}.{1}.html", this.ControllerName, view));
                    if (stream != null)
